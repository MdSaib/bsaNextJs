...
export default function UserManagementPage() {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const mockUsers = [
          { id: '1', name: 'John Doe', role: 'Officer', email: 'john@example.com' },
          { id: '2', name: 'Jane Smith', role: 'Admin', email: 'jane@example.com' },
          { id: '3', name: 'Alice Johnson', role: 'Officer', email: 'alice@example.com' },
        ];
        setUsers(mockUsers);
        setLoading(false);
      } catch (err) {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '50px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '10px' }}>
      ...
      <p style={{ textAlign: 'center' }}>View and manage users in the system.</p>
