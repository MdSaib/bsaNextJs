    ...
    <div style={{ maxWidth: '800px', margin: '50px auto', padding: '20px' }}>
      ...
      {!loading && !error && fileDetails && (
        <div style={{ marginTop: '20px' }}>
          ...
          <p>
            <strong>Description:</strong> {fileDetails.description}
          </p>
          <p>
            <strong>Status:</strong> {fileDetails.status}
          </p>
          <p>
            <strong>Current Step:</strong> {fileDetails.currentStep}
          </p>
          <h3>Workflow</h3>
          <ol>
            {fileDetails.workflow.map((step, index) => (
              <li
                ...
                style={{
                  ...
                  fontWeight:
                    step === fileDetails.currentStep ? 'bold' : 'normal',
                }}
              >
                {step}
              </li>
