...
export default function ForgotPasswordPage() { // Default export here
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '50px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '10px' }}>
      ...
      <p style={{ textAlign: 'center' }}>Enter your email to receive a password reset link.</p>
      ...
      <p style={{ marginTop: '20px', textAlign: 'center' }}>
        <Link legacyBehavior href="/auth/login"><a style={{ color: '#0070f3', textDecoration: 'none' }}>Back to Login</a></Link>
      </p>
    </div>
  );
}
